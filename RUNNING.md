...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022_DY.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022EE_DY.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022EE_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2022EE_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023_DY.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023BPix_DY.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023BPix_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2023BPix_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2024_DY_VBFFil.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2024_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2025_DY_minnlo.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2025_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2025_data.root
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2026_DY_VBFFil.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --dataset-name VBFHto2Mu_M125_powheg \
  --input-file root://cms-xrd-global.cern.ch//store/mc/RunIII2024Summer24NanoAODv15/VBFH-Hto2Mu_Par-M-125_TuneCP5_13p6TeV_powheg-pythia8/NANOAODSIM/150X_mcRun3_2024_realistic_v2-v2/100000/f05fbcb1-50b6-4d4e-9923-19678675ee4a.root \
  --output-file /tmp/vdamante/test_skim_Run3_2026_VBF.root \
  --want-variations
```
...
python3 analysis/skim.py \
  ...
  --output-file /tmp/vdamante/test_skim_Run3_2026_data.root
```
...
python3 histograms/hist_maker.py \
  --era Run3_2022 \
  --dataset-name DYto2L_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2022/DYto2L_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  --era Run3_2022EE \
  --dataset-name DYto2L_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2022EE/DYto2L_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  --era Run3_2023 \
  --dataset-name DYto2L_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2023/DYto2L_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  --era Run3_2023BPix \
  --dataset-name DYto2L_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2023BPix/DYto2L_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  ...
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2024/DYto2Mu_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  --era Run3_2025 \
  --dataset-name DYto2Mu_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2025/DYto2Mu_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  --era Run3_2026 \
  --dataset-name DYto2Mu_M_50_amcatnloFXFX \
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2026/DYto2Mu_M_50_amcatnloFXFX/FILE_skim.root \
...
python3 histograms/hist_maker.py \
  ...
  --input /eos/cms/store/group/phys_higgs/cmshmm/vdamante/skim_v1_noUnc/Run3_2024/${dataset_name}/ \
