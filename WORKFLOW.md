...
- `common/manifests.py`: manifest schema, validation, and atomic writes.
- `common/helpers.py`: shared RDF construction and observables.
- `common/histogram_pipeline.py`: shared selections and weight composition.
